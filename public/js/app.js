...
$(document).ready(function () {
  ...
  deleteMessage = function deleteMessage(id) {
    var result = confirm("Do you want to delete message?"); //console.log(result); 驗證result 帶入0,1 OK

    if (result) {
      var actionUrl = "/messages/" + id; //組合網址
...
__webpack_require__(/*! C:\Users\USER\Documents\26-紅門工作相關\messageboard2\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\USER\Documents\26-紅門工作相關\messageboard2\resources\sass\app.scss */"./resources/sass/app.scss");
